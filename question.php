...
/**
 * Represents an essaygnrquiz question.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essaygnrquiz_question extends question_with_responses {
     ...
     * @return qtype_essaygnrquiz_format_renderer_base the response-format-specific renderer.
     */
    public function get_format_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_essaygnrquiz', 'format_' . $this->responseformat);
    }
    ...
    public function check_file_access($qa, $options, $component, $filearea, $args, $forcedownload) {
        ...
        } else if ($component == 'qtype_essaygnrquiz' && $filearea == 'graderinfo') {
