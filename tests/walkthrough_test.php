...
/**
 * This file contains tests that walks essaygnrquiz questions through some attempts.
 *
...
/**
 * Unit tests for the essaygnrquiz question type.
 *
 * @copyright 2013 The Open University
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essaygnrquiz_walkthrough_testcase extends qbehaviour_walkthrough_test_base {
    ...
    public function test_deferred_feedback_html_editor() {
        ...
        // Create an essaygnrquiz question.
        $q = test_question_maker::make_question('essaygnrquiz', 'editor');
    ...
    public function test_deferred_feedback_plain_text() {
        ...
        // Create an essaygnrquiz question.
        $q = test_question_maker::make_question('essaygnrquiz', 'plain');
        $this->start_attempt_at_question($q, 'deferredfeedback', 1);
    ...
    public function test_responsetemplate() {
        ...
        // Create an essaygnrquiz question.
        $q = test_question_maker::make_question('essaygnrquiz', 'responsetemplate');
        $this->start_attempt_at_question($q, 'deferredfeedback', 1);
    ...
    public function test_deferred_feedback_html_editor_with_files_attempt_on_last() {
        ...
        // Create an essaygnrquiz question in the DB.
        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category();
        $question = $generator->create_question('essaygnrquiz', 'editorfilepicker', array('category' => $cat->id));
    ...
    public function test_deferred_feedback_plain_attempt_on_last() {
        ...
        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category();
        $question = $generator->create_question('essaygnrquiz', 'plain', array('category' => $cat->id));
