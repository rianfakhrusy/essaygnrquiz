...
Feature: Preview Essay questions
  ...
  Scenario: Preview an Essay question and submit a partially correct response.
    When I click on "Preview" "link" in the "essaygnrquiz-001" "table_row"
  ...
  @javascript @_switch_window
  Scenario: Preview an Essay question and submit a partially correct response.
    When I click on "Preview" "link" in the "essaygnrquiz-002" "table_row"
    And I switch to "questionpreview" window
    And I set the field "How questions behave" to "Immediate feedback"
    And I press "Start again with these options"
    And I should see "Please write a story about a frog."
  ...
  @javascript @_switch_window
  Scenario: Preview an Essay question and submit a partially correct response.
    When I click on "Preview" "link" in the "essaygnrquiz-003" "table_row"
    And I switch to "questionpreview" window
    And I set the field "How questions behave" to "Immediate feedback"
    And I press "Start again with these options"
    And I should see "Please write a story about a frog."
