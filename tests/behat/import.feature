...
Feature: Test importing Essay questions
  ...
  Scenario: import Essay question.
    ...
    And I upload "question/type/essaygnrquiz/tests/fixtures/testquestion.moodle.xml" file to "Import" filemanager
    And I press "id_submitbutton"
    Then I should see "Parsing questions from import file."
    And I should see "Importing 1 questions from file"
    And I should see "Write an essaygnrquiz with 500 words."
