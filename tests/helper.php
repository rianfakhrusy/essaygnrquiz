...
/**
 * Test helpers for the essaygnrquiz question type.
 *
 * @package    qtype_essaygnrquiz
...
/**
 * Test helper class for the essaygnrquiz question type.
 *
 * @copyright  2013 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essaygnrquiz_test_helper extends question_test_helper {
     ...
     * @return qtype_essaygnrquiz_question
     */
    protected function initialise_essaygnrquiz_question() {
        question_bank::load_question_definition_classes('essaygnrquiz');
        $q = new qtype_essaygnrquiz_question();
        ...
        $q->qtype = question_bank::get_qtype('essaygnrquiz');

        return $q;
    }

    /**
     * Makes an essaygnrquiz question using the HTML editor as input.
     * @return qtype_essaygnrquiz_question
     */
    public function make_essaygnrquiz_question_editor() {
        return $this->initialise_essaygnrquiz_question();
    }

    /**
     * Make the data what would be received from the editing form for an essaygnrquiz
     ...
     */
    public function get_essaygnrquiz_question_form_data_editor() {
    ...
    /**
     * Makes an essaygnrquiz question using the HTML editor allowing embedded files as
     * input, and up to three attachments.
     * @return qtype_essaygnrquiz_question
     */
    public function make_essaygnrquiz_question_editorfilepicker() {
        $q = $this->initialise_essaygnrquiz_question();
     ...
     * @return stdClass the data that would be returned by $form->get_gata();
     */
    public function get_essaygnrquiz_question_form_data_editorfilepicker() {
        $fromform = new stdClass();
    ...
    /**
     * Makes an essaygnrquiz question using plain text input.
     * @return qtype_essaygnrquiz_question
     */
    public function make_essaygnrquiz_question_plain() {
        $q = $this->initialise_essaygnrquiz_question();
     ...
     * @return stdClass the data that would be returned by $form->get_gata();
     */
    public function get_essaygnrquiz_question_form_data_plain() {
        $fromform = new stdClass();
    ...
    /**
     * Makes an essaygnrquiz question using monospaced input.
     * @return qtype_essaygnrquiz_question
     */
    public function make_essaygnrquiz_question_monospaced() {
        $q = $this->initialise_essaygnrquiz_question();
        $q->responseformat = 'monospaced';
        return $q;
    }

    public function make_essaygnrquiz_question_responsetemplate() {
        $q = $this->initialise_essaygnrquiz_question();
    ...
    /**
     * Makes an essaygnrquiz question without an inline text editor.
     * @return qtype_essaygnrquiz_question
     */
    public function make_essaygnrquiz_question_noinline() {
        $q = $this->initialise_essaygnrquiz_question();
